...
namespace filesystem
{
	...
	// todo
	// name check policy
	// nfs vfs policy fuers iteraten etc.

  //  path -------------------------------------------------------------------//

    class YAKE_FILESYSTEM_DECL path
    {
    public:
  ...
  //  path::name_checks  ---------------------------------------------------//
    ...
    YAKE_FILESYSTEM_DECL bool portable_posix_name( const std::string & name );
    YAKE_FILESYSTEM_DECL bool windows_name( const std::string & name );
    YAKE_FILESYSTEM_DECL bool portable_name( const std::string & name );
    YAKE_FILESYSTEM_DECL bool portable_directory_name( const std::string & name );
    YAKE_FILESYSTEM_DECL bool portable_file_name( const std::string & name );
    YAKE_FILESYSTEM_DECL bool no_check( const std::string & name );   // always returns true
    YAKE_FILESYSTEM_DECL bool native( const std::string & name );
