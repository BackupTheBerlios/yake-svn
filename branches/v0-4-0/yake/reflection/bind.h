...
// todo: defined in bind_network because we have observers etc. so move it
/* define a reflected default property with optional bindings */
/*#define DEFAULT_PROPERTY(TYPE, NAME, BINDING1, BINDING2) \
	BINDING1##_DEFAULT_PROPERTY_DEFAULT(TYPE, NAME) \
	BINDING2##_DEFAULT_PROPERTY_DEFAULT(TYPE, NAME) \
	RX_DEFAULT_PROPERTY(TYPE, NAME)

#define _DEFAULT_PROPERTY_DEFAULT(TYPE, NAME) // nothing
#define net_DEFAULT_PROPERTY_DEFAULT(TYPE, NAME) NET_DEFAULT_PROPERTY(TYPE, NAME)
#define lua_DEFAULT_PROPERTY_DEFAULT(TYPE, NAME) LUA_DEFAULT_PROPERTY(TYPE, NAME)*/


// todo: add net observer stuff etc. see default_property
/* define a reflected property with optional bindings */
#define PROPERTY(TYPE, NAME, BINDING1, BINDING2) \
...
/* define a reflected custom event with optional bindings */
#define CUSTOM_EVENT(ACCESS_ATTR, EVENT_CLASS, EVENT_NAME, BINDING1, BINDING2) \
	RX_CUSTOM_EVENT(ACCESS_ATTR, EVENT_CLASS, EVENT_NAME); \
	BINDING1##_CUSTOM_EVENT_DEFAULT(ACCESS_ATTR, EVENT_CLASS, EVENT_NAME) \
	BINDING2##_CUSTOM_EVENT_DEFAULT(ACCESS_ATTR, EVENT_CLASS, EVENT_NAME)

#define _CUSTOM_EVENT_DEFAULT(ACCESS_ATTR, EVENT_CLASS, EVENT_NAME) // nothing
#define lua_CUSTOM_EVENT_DEFAULT(ACCESS_ATTR, EVENT_CLASS, EVENT_NAME) LUA_CUSTOM_EVENT(ACCESS_ATTR, EVENT_CLASS, EVENT_NAME)
