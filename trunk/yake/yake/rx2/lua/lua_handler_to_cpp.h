...
namespace
{
    ...
    struct forward_call
		...
		static boost::function_base & lua_function_to_cpp( const luabind::functor<void> & lua_function )
		{
			...
			return *new boost::function< void() >( boost::bind( 
				&forward_call::on_forward_call, forward ) );
		}
	};
    ...
    struct forward_call
		...
		{
			forward_call * forward = new forward_call( lua_function );
			return *new boost::function< void( boost::any ) >( boost::bind( 
				&forward_call::on_forward_call, forward, _1 ) );
		}
	};
