...
yake::base::Templates::Detail::TrackerArray yake::base::Templates::Detail::pTrackerArray = 0;
unsigned int yake::base::Templates::Detailelements = 0;


void yake::base::Templates::Detail::AtExitFn()
{
