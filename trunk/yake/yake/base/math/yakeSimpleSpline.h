/**------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------
*/
#ifndef YAKE_MATH_SIMPLESPLINE_H
#define YAKE_MATH_SIMPLESPLINE_H
...
namespace math {
	...
	@remarks
		This implementation was shamelessly ripped from OGRE (http://www.ogre3d.org).
    @par
        ...
        created for you. 
    */
    class YAKE_BASE_API SimpleSpline
    {
    public:
        SimpleSpline();
        ~SimpleSpline();
