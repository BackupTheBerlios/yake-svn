...
#include <inc/base/math/yakeMatrix3.h>
#include <inc/base/math/yakeMath.h>
...
namespace math
{
        ...
        Matrix3& kR)
    {
        ...
        if ( fLength > 0.0 )
        {
            ...
            kL[1][1] = (real) 1.0+fT2*afV[1]*afV[1];
            kL[1][2] = kL[2][1] = fT2*afV[1]*afV[2];
            kL[2][2] = (real) 1.0+fT2*afV[2]*afV[2];
            bIdentity = false;
        }
        else
        {
        ...
        if ( fLength > 0.0 )
        {
            ...
            kR[2][2] = (real) 1.0+fT2*afV[2]*afV[2];
        }
        else
        {
            kR = Matrix3::IDENTITY;
        ...
        Matrix3& kR)
    {
        ...
        real fDiscr = (real) Math::Sqrt(fDiff*fDiff+(real)4.0*fT12*fT12);
        ...
        for (int i = 0; i < ms_iSvdMaxIterations; i++)
        {
            ...
            if ( bTest1 )
            {
                ...
                else
                {
                    ...
                    fTan0 = (real)0.5*(fTmp+ (real)Math::Sqrt(fTmp*fTmp + (real)4.0));
                    fCos0 = (real) Math::InvSqrt((real)1.0+fTan0*fTan0);
                    fSin0 = fTan0*fCos0;
                    ...
                    fCos1 = (real) Math::InvSqrt((real)1.0+fTan1*fTan1);
                    fSin1 = -fTan1*fCos1;
            ...
            else
            {
                if ( bTest2 )
                {
                    ...
                    fTan0 = (real) 0.5*(-fTmp+Math::Sqrt(fTmp*fTmp + (real)4.0));
    ...
    real Matrix3::MaxCubicRoot (real afCoeff[3])
    {
        ...
        real fDiscr = (real) afCoeff[2]*afCoeff[2] - (real)3.0*afCoeff[1];
        if ( fDiscr <= fEpsilon )
        ...
        if ( fPoly < 0.0 )
        {
            ...
            real fTmp = (real) 1.0+Math::Abs(afCoeff[1]);
            if ( fTmp > fX )
                fX = fTmp;
            fTmp = (real) 1.0+Math::Abs(afCoeff[2]);
            if ( fTmp > fX )
                fX = fTmp;
        }

        // Newton's method to find root
        real fTwoC2 = (real) 2.0*afCoeff[2];
        for (int i = 0; i < 16; i++)
        {
            ...
            real fDeriv = (real) afCoeff[1]+fX*(fTwoC2+(real)3.0*fX);
            fX -= fPoly/fDeriv;
        }
            ...
            else
            {
                ...
                if ( m[0][0] >= m[1][1] )
                {
                    ...
                    if ( m[0][0] >= m[2][2] )
                    {
                        ...
                        rkAxis.x = (real) 0.5*Math::Sqrt(m[0][0] -
                            m[1][1] - m[2][2] + (real)1.0);
                        fHalfInverse = (real) 0.5/rkAxis.x;
                    ...
                    else
                    {
                        ...
                        rkAxis.z = (real) 0.5*Math::Sqrt(m[2][2] -
                            m[0][0] - m[1][1] + (real)1.0);
                        fHalfInverse = (real) 0.5/rkAxis.z;
                ...
                else
                {
                    ...
                    if ( m[1][1] >= m[2][2] )
                    {
                        ...
                        rkAxis.y = (real) 0.5*Math::Sqrt(m[1][1] -
                            m[0][0] - m[2][2] + (real)1.0);
                        fHalfInverse = (real) 0.5/rkAxis.y;
    ...
    bool Matrix3::QLAlgorithm (real afDiag[3], real afSubDiag[3])
    {
        ...
        for (int i0 = 0; i0 < 3; i0++)
        {
            ...
            for (iIter = 0; iIter < iMaxIter; iIter++)
            {
                ...
                real fTmp0 = (real) (afDiag[i0+1]-afDiag[i0])/((real)2.0*afSubDiag[i0]);
                real fTmp1 = (real) Math::Sqrt(fTmp0*fTmp0+(real)1.0);
                if ( fTmp0 < 0.0 )
                ...
                for (int i2 = i1-1; i2 >= i0; i2--)
                {
                    ...
                    {
                        fCos = fTmp0/fTmp3;
                        fTmp1 = (real) Math::Sqrt(fCos*fCos+(real)1.0);
                    ...
                    {
                        fSin = fTmp3/fTmp0;
                        fTmp1 = (real) Math::Sqrt(fSin*fSin+(real)1.0);
                        afSubDiag[i2+1] = fTmp0*fTmp1;
                        fCos = (real) 1.0/fTmp1;
                        fSin *= fCos;
                    }
                    fTmp0 = afDiag[i2+1]-fTmp2;
                    fTmp1 = (real) (afDiag[i2]-fTmp0)*fSin+(real)2.0*fTmp4*fCos;
                    fTmp2 = fSin*fTmp1;
